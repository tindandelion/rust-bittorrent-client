...
And that's true, if we had to program like that, it would be a nightmare of a job. That's where the distinction between leaf and non-leaf futures becomes important.
